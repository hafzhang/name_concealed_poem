...
export const AzurePorcelain = ({ children }: MountingProps) => {
  return React.createElement('div', {
    ...
    // 四角装饰
    React.createElement('div', { style: { display: 'flex', position: 'absolute', top: '35px', left: '35px' } }, CornerPattern()),
    React.createElement('div', { style: { display: 'flex', position: 'absolute', top: '35px', right: '35px', transform: 'scaleX(-1)' } }, CornerPattern()),
    React.createElement('div', { style: { display: 'flex', position: 'absolute', bottom: '35px', left: '35px', transform: 'scaleY(-1)' } }, CornerPattern()),
    React.createElement('div', { style: { display: 'flex', position: 'absolute', bottom: '35px', right: '35px', transform: 'scale(-1,-1)' } }, CornerPattern()),
    // 青花边框
    PorcelainBorder(),
    // 内边框
    React.createElement('div', {
