  ...
  return {
    ...
    props: {
      ...
      children: [
        ...
        // 四角装饰
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', top: '45px', left: '45px' }, children: CornerFlower() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', top: '45px', right: '45px' }, children: CornerFlower() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', bottom: '45px', left: '45px' }, children: CornerFlower() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', bottom: '45px', right: '45px' }, children: CornerFlower() } },
        // 内容区
        {
          type: 'div',
          props: {
