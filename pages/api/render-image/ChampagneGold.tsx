  ...
  return {
    ...
    props: {
      ...
      children: [
        ...
        // 四角 Art Deco 装饰
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', top: '45px', left: '45px' }, children: DecoCorner() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', top: '45px', right: '45px', transform: 'scaleX(-1)' }, children: DecoCorner() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', bottom: '45px', left: '45px', transform: 'scaleY(-1)' }, children: DecoCorner() } },
        { type: 'div', props: { style: { display: 'flex', position: 'absolute', bottom: '45px', right: '45px', transform: 'scale(-1,-1)' }, children: DecoCorner() } },
        // 金色主边框
        GoldBorder(),
        // 内容区
        {
